...
![小工参考形象](xiaogong-illustrator/assets/reference/xiaogong-front.png)
...
| 白板讲解 | 焊接电路板 | 机柜检修 |
|:---:|:---:|:---:|
| ![白板](xiaogong-illustrator/assets/reference/xiaogong-whiteboard-final.jpg) | *(见下方说明)* | *(见下方说明)* |
...
参考底图：`xiaogong-illustrator/assets/reference/xiaogong-front.png`
...
将 `xiaogong-illustrator/` 子目录放入 EasyClaw 的 skills 目录，EasyClaw 会自动加载该 Skill。
...
```
用 xiaogong-illustrator skill 帮我分析这篇文章的配图方案
```

```
用 xiaogong-illustrator skill 为下面的文章生成 4-6 张正文配图
```
...
```
用 xiaogong-illustrator skill 分析这篇文章哪里值得配图，输出 shot list。
...
│       └── ...
├── xiaogong-illustrator/        # Skill 核心目录
│   ├── SKILL.md
│   ├── assets/
...
本项目基于 [Ian Xiaohei Illustrations](https://github.com/helloianneo/xiaogong-illustrator) 演化而来。
